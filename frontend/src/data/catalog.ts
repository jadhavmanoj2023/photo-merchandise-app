...
export const catalogProducts: CatalogProduct[] = [
  ...
  // Photo Print (Zoomin)
  {
    id: 'pp-portrait-matte',
    categorySlug: 'photo-print',
    name: 'Matte Portrait Photo Print',
    frameTemplateId: 'portrait-white',
    price: 299,
    originalPrice: 499,
    description: 'Archival matte paper with rich, non-reflective finish.',
    image: 'https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=500',
    sizes: portraitSizes.map((s) => ({ ...s, price: Math.round(s.price * 0.45) })),
    thicknesses: ['200 GSM', '300 GSM'],
  },
  {
    id: 'pp-landscape-glossy',
    categorySlug: 'photo-print',
    name: 'Glossy Landscape Photo Print',
    frameTemplateId: 'landscape-black',
    price: 349,
    originalPrice: 549,
    description: 'Vibrant glossy finish that makes colours pop.',
    image: 'https://images.unsplash.com/photo-1509048191080-d2984bad6ae5?w=500',
    sizes: landscapeSizes.map((s) => ({ ...s, price: Math.round(s.price * 0.45) })),
    thicknesses: ['200 GSM', '300 GSM'],
  },
  {
    id: 'pp-square-lustre',
    categorySlug: 'photo-print',
    name: 'Premium Lustre Square Print',
    frameTemplateId: 'square-black',
    price: 399,
    description: 'Professional lustre paper — balanced between matte and glossy.',
    image: 'https://images.unsplash.com/photo-1532372576444-dda954194ad0?w=500',
    sizes: squareSizes.map((s) => ({ ...s, price: Math.round(s.price * 0.4) })),
    thicknesses: ['250 GSM', '350 GSM'],
  },
  {
    id: 'pp-rounded-landscape',
    categorySlug: 'photo-print',
    name: 'Rounded Corner Landscape Print',
    frameTemplateId: 'rounded-rect-landscape',
    price: 449,
    description: 'Soft rounded corners for a modern print look without a frame.',
    image: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=500',
    sizes: landscapeSizes.map((s) => ({ ...s, price: Math.round(s.price * 0.5) })),
    thicknesses: ['250 GSM'],
  },
